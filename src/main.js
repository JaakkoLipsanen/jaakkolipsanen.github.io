...
const componentMap = new Map([["404.html", "blog-page"], ["cycle4", "cycle-page"], ["code32", "code-page"]]);
...
var app = new Vue({
	...
	data: {
		currentView: componentMap.has(pagePath[0]) ? componentMap.get(pagePath[0]) : "cycle-page"
	}
});
